...
28/5/26
- ปรับโครงสร้างระบบแบบรวมศูนย์ (Shared Modules) สำหรับโมดูล Settings, Schedule, User Management, Activity, Attendance Approve และ Attendance Logging ทำให้ลบโค้ดซ้ำซ้อนและลดขนาดไฟล์ลงไปได้กว่า 7,800 บรรทัด
- เพิ่มฟีเจอร์ "เลขที่" (Roll Number) ของนักเรียนตั้งแต่หน้าลงทะเบียน, การแสดงผลในตารางประวัติ, การจัดการโปรไฟล์ และการส่งออกรายงาน (CSV/Excel)
- จำกัดสิทธิ์การเข้าถึงหน้าลงทะเบียนเจ้าหน้าที่ (#admin-register) ให้เข้าถึงได้เฉพาะแอดมินที่ล็อกอินแล้วเท่านั้น โดยถอดปุ่มลิงก์ทางออกจากหน้าล็อกอินหลักและจำกัดสิทธิ์ระดับ Routing
- รีแฟกเตอร์และปรับโครงสร้างการดึงสถิติรายวันและการกดลิงก์ต่าง ๆ ในหน้า Admin Dashboard ให้มีความเสถียรยิ่งขึ้น
- ตั้งค่าระบบการย้ายฐานข้อมูลและบัคเก็ตด้วยการตั้งค่า Supabase config และ migration ในโปรเจกต์