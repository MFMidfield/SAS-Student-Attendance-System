...
2.  **[Logic] Smart Subject Locking**: เมื่อกด "มาเรียน" ให้ระบบล็อกวิชาตามเวลาปัจจุบันอัตโนมัติ
3.  **[Logic] Conditional Leave**: ระบบเลือกลา (กิจ/ป่วย) พร้อมบังคับใส่เหตุผล
