...
export function initAdminActivity(imageLogo, imageBander) {
    ...
    const renderActivities = () => {
        ...
        activitiesData.forEach(activity => {
            ...
            div.className = 'bg-white border-2 border-[#1E1E1E] shadow-[3px_3px_0px_#1E1E1E] overflow-hidden';
            div.innerHTML = `
                <div class="flex items-stretch">
                    <!-- Date Badge -->
                    <div class="w-16 shrink-0 bg-[#F2C00F] border-r-2 border-[#1E1E1E] flex flex-col items-center justify-center p-2">
                        <span class="text-[8px] font-black text-[#1E1E1E]/60 uppercase">${monthShort}</span>
                        <span class="text-xl font-black text-[#1E1E1E] leading-tight">${dayNum}</span>
                        <span class="text-[8px] font-black text-[#1E1E1E]/60 uppercase">${dayShort}</span>
                    </div>
                    <!-- Event Content -->
                    <div class="flex-1 p-3">
                        <div class="flex items-start justify-between gap-2">
                            <div class="flex-1 flex flex-col min-w-0">
                                ...
                                <p class="text-[9px] font-bold text-[#1E1E1E]/40 mt-1 line-clamp-2">${escapeHtml(activity.description || 'No description')}</p>
                            </div>
                        </div>
                    </div>
